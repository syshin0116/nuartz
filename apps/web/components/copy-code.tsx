...
export function CopyCode() {
  useEffect(() => {
    ...
    figures.forEach((figure) => {
      ...
      btn.className =
        "copy-code-btn absolute top-1.5 right-2 rounded p-1 text-muted-foreground hover:text-foreground bg-muted/50 hover:bg-muted transition-colors cursor-pointer"
      btn.innerHTML =
